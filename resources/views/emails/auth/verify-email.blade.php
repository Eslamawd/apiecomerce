            ...
            <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;">
                <tr>
                    <td style="padding:22px 24px;background:linear-gradient(135deg,#0ea5e9 0%,#14b8a6 55%,#22c55e 100%);color:#ffffff;">
                        ...
                        <h1 style="margin:8px 0 0;font-size:24px;line-height:1.35;">Verify Your Account</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:24px;">
                        ...
                        <p style="margin:0 0 16px;font-size:14px;color:#374151;line-height:1.8;">
                            Please confirm your email address to finish activating your <strong>{{ $appName }}</strong> account.
                        </p>

                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:18px 0 16px;">
                            <tr>
                                <td align="center">
                                    <a href="{{ $verificationUrl }}" style="display:inline-block;background:#0ea5e9;color:#ffffff;text-decoration:none;padding:12px 22px;border-radius:10px;font-size:14px;font-weight:700;">
                                        Verify Email
                                    </a>
                                </td>
                            </tr>
                        ...
                        <p style="margin:0 0 12px;font-size:12px;word-break:break-all;color:#0f172a;">{{ $verificationUrl }}</p>
